...
void InitFlash(void)
{
    ...
    * Set the Paged Waitstate for the Flash
    */
    FlashRegs.FBANKWAIT.bit.PAGEWAIT = 3U;

    /*
    * Set the Random Waitstate for the Flash
    */
    FlashRegs.FBANKWAIT.bit.RANDWAIT = 3U;

    /*
    * Set the Waitstate for the OTP
    */
    FlashRegs.FOTPWAIT.bit.OTPWAIT = 5U;
#endif
    /*
    *                CAUTION
...
*/
void InitPll(uint16_t val, uint16_t divsel)
{
    /*
...
void InitPeripheralClocks(void)
{
    ...
    * default values
    */
    SysCtrlRegs.HISPCP.all = 0x0001U;
    ...
    */
    ...
    SysCtrlRegs.PCLKCR0.bit.I2CAENCLK = 1U;   /* I2C*/
    SysCtrlRegs.PCLKCR0.bit.SCIAENCLK = 1U;   /* SCI-A*/
    SysCtrlRegs.PCLKCR0.bit.SCIBENCLK = 1U;   /* SCI-B*/
    SysCtrlRegs.PCLKCR0.bit.SCICENCLK = 1U;   /* SCI-C*/
    SysCtrlRegs.PCLKCR0.bit.SPIAENCLK = 1U;   /* SPI-A*/
    SysCtrlRegs.PCLKCR0.bit.MCBSPAENCLK = 1U; /* McBSP-A*/
    SysCtrlRegs.PCLKCR0.bit.MCBSPBENCLK = 1U; /* McBSP-B*/
    SysCtrlRegs.PCLKCR0.bit.ECANAENCLK = 1U;    /* eCAN-A*/
    SysCtrlRegs.PCLKCR0.bit.ECANBENCLK = 1U;    /* eCAN-B*/

    SysCtrlRegs.PCLKCR0.bit.TBCLKSYNC = 0U;   /* Disable TBCLK within the ePWM*/
    ...
    SysCtrlRegs.PCLKCR1.bit.EPWM5ENCLK = 1U;  /* ePWM5*/
    SysCtrlRegs.PCLKCR1.bit.EPWM6ENCLK = 1U;  /* ePWM6*/
    SysCtrlRegs.PCLKCR0.bit.TBCLKSYNC = 1U;   /* Enable TBCLK within the ePWM*/

    SysCtrlRegs.PCLKCR1.bit.ECAP3ENCLK = 1U;  /* eCAP3*/
    SysCtrlRegs.PCLKCR1.bit.ECAP4ENCLK = 1U;  /* eCAP4*/
    SysCtrlRegs.PCLKCR1.bit.ECAP5ENCLK = 1U;  /* eCAP5*/
    SysCtrlRegs.PCLKCR1.bit.ECAP6ENCLK = 1U;  /* eCAP6*/
    SysCtrlRegs.PCLKCR1.bit.ECAP1ENCLK = 1U;  /* eCAP1*/
    SysCtrlRegs.PCLKCR1.bit.ECAP2ENCLK = 1U;  /* eCAP2*/
    SysCtrlRegs.PCLKCR1.bit.EQEP1ENCLK = 1U;  /* eQEP1*/
    SysCtrlRegs.PCLKCR1.bit.EQEP2ENCLK = 1U;  /* eQEP2*/
    ...
    SysCtrlRegs.PCLKCR3.bit.DMAENCLK = 1U;       /* DMA Clock*/
    SysCtrlRegs.PCLKCR3.bit.XINTFENCLK = 1U;     /* XTIMCLK*/
    SysCtrlRegs.PCLKCR3.bit.GPIOINENCLK = 1U;    /* GPIO input clock*/
...
#define STATUS_SUCCESS       (1U)
uint16_t CsmUnlock(void)
{
    ...
    */
    EALLOW;
    CsmRegs.KEY0 = 0xFFFFU;
    CsmRegs.KEY1 = 0xFFFFU;
    CsmRegs.KEY2 = 0xFFFFU;
    CsmRegs.KEY3 = 0xFFFFU;
    CsmRegs.KEY4 = 0xFFFFU;
    CsmRegs.KEY5 = 0xFFFFU;
    CsmRegs.KEY6 = 0xFFFFU;
    CsmRegs.KEY7 = 0xFFFFU;
    EDIS;
    ...
    */
    if (CsmRegs.CSMSCR.bit.SECURE == 0U)
    {
        temp = STATUS_SUCCESS;
    }
    else 
